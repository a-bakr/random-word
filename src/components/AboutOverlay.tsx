      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col px-8 pt-4 pb-10 relative">
              <button
                onClick={onClose}
                className={`absolute top-2 ${lang.direction === 'rtl' ? 'left-2' : 'right-2'} p-2 text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors`}
              >
