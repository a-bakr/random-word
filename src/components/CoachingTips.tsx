    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="absolute bottom-8 inset-x-0 flex items-center justify-center gap-2 z-10 pointer-events-none"
        >
          {tips.map((tip, i) => (
            <motion.button
              ...
              className={`pointer-events-auto px-3 py-1.5 rounded-full text-[11px] font-semibold tracking-widest
